// ignore_for_file: non_constant_identifier_names, use_key_in_widget_constructors, avoid_types_as_parameter_names
    ...
    return Scaffold(
      ...
      body: Consumer<Cart>(
        builder: (context, Cart, child) {
          return Cart.basketitem.isEmpty
              ? Center(
                  child: Column(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                  'BUY  ${Cart.basketitem.length.toString()} '
